...
class Brc:
    ...
    def header_decl(self):
        md5 = self._md5
        decl = self.extern_c_begin()
        decl += f'void bl_register_resource_{md5}();\n'
        decl += self.extern_c_end()
